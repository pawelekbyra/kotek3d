...
### NOWY PROJEKT: STATKI 3D - BITWA O OCEAN
W ramach rozwoju interaktywnych elementów Polutka, stworzyliśmy **STATKI 3D**. Jest to dynamiczny symulator bitwy morskiej zbudowany w Next.js przy użyciu Three.js i React Three Fiber.

**Cechy gry:**
- **Statek:** Proceduralnie modelowany żaglowiec z fizyką bezwładności i przechyłów na falach.
- **Świat:** Dynamiczny ocean generowany za pomocą Simplex Noise, nocna sceneria z gwieździstym niebem i nastrojowym oświetleniem.
- **Mechanika Walki:** System strzelania z armat z uwzględnieniem balistyki pocisków i detekcją kolizji.
- **Przeciwnicy:** Flota wrogich statków rozproszona po oceanie, dryfująca na falach.
- **Sterowanie:** WASD do manewrowania statkiem, Spacja do oddania strzału z armaty.
- **Cel:** Zatopienie jak największej liczby wrogich jednostek i bicie rekordów w "Statusie Floty".
